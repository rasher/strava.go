...
func (a *SegmentsApiService) ExploreSegmentsExecute(r ApiExploreSegmentsRequest) (*ExplorerResponse, *http.Response, error) {
	...
	localVarQueryParams.Add("bounds", parameterToString(*r.bounds, "csv"))
	if r.activityType != nil {
		localVarQueryParams.Add("activity_type", parameterToString(*r.activityType, ""))
	}
	if r.minCat != nil {
		localVarQueryParams.Add("min_cat", parameterToString(*r.minCat, ""))
	}
	if r.maxCat != nil {
		localVarQueryParams.Add("max_cat", parameterToString(*r.maxCat, ""))
	}
...
func (a *SegmentsApiService) StarSegmentExecute(r ApiStarSegmentRequest) (*DetailedSegment, *http.Response, error) {
	...
	localVarFormParams.Add("starred", parameterToString(*r.starred, ""))
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
