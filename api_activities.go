...
func (a *ActivitiesApiService) CreateActivityExecute(r ApiCreateActivityRequest) (*DetailedActivity, *http.Response, error) {
	...
	localVarFormParams.Add("sport_type", parameterToString(*r.sportType, ""))
	localVarFormParams.Add("start_date_local", parameterToString(*r.startDateLocal, ""))
	localVarFormParams.Add("elapsed_time", parameterToString(*r.elapsedTime, ""))
	if r.description != nil {
		localVarFormParams.Add("description", parameterToString(*r.description, ""))
	}
	if r.distance != nil {
		localVarFormParams.Add("distance", parameterToString(*r.distance, ""))
	}
	if r.trainer != nil {
		localVarFormParams.Add("trainer", parameterToString(*r.trainer, ""))
	}
	if r.commute != nil {
		localVarFormParams.Add("commute", parameterToString(*r.commute, ""))
	}
...
func (a *ActivitiesApiService) GetActivityByIdExecute(r ApiGetActivityByIdRequest) (*DetailedActivity, *http.Response, error) {
	...
	if r.includeAllEfforts != nil {
		localVarQueryParams.Add("include_all_efforts", parameterToString(*r.includeAllEfforts, ""))
	}
	// to determine the Content-Type header
